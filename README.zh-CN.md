...
- 一个稳定桥接 target，底层使用版本化内部二进制 target，当前为 `LibtorrentAppleBinary_0_3_1`
...
- 最新公开包版本：`0.3.1`
- 当前二进制产物：`https://github.com/clOudbb/libtorrent-apple/releases/download/v0.3.1/LibtorrentAppleBinary-0.3.1.zip`
- 当前 binary module 身份：`LibtorrentAppleBinary_0_3_1`
...
- 公开包始终通过稳定名字的 `LibtorrentAppleBridge` 内部桥接层访问底层二进制，而每个 release 都拥有独立的版本化 binary module 身份，例如 `LibtorrentAppleBinary_0_3_1`。
