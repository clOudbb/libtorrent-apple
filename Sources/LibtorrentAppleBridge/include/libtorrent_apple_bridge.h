...
typedef struct {
    ...
    int32_t announce_to_all_trackers;
    int32_t announce_to_all_tiers;
    int32_t peer_turnover;
    int32_t peer_turnover_cutoff;
    int32_t peer_turnover_interval;
    int32_t connection_speed;
    int32_t torrent_connect_boost;
    int32_t mixed_mode_algorithm;
    int32_t choking_algorithm;
    int32_t seed_choking_algorithm;
    int32_t max_out_request_queue;
    int32_t max_allowed_in_request_queue;
    int32_t whole_pieces_threshold;
    int32_t piece_extent_affinity;
    int32_t suggest_mode;
    int32_t aio_threads;
    int32_t checking_mem_usage;
    int32_t file_pool_size;
    int32_t max_concurrent_http_announces;
    int32_t stop_tracker_timeout;
    int32_t rate_limit_ip_overhead;
    int32_t allow_multiple_connections_per_ip;
    int32_t validate_https_trackers;
    int32_t ssrf_mitigation;
    int32_t enable_outgoing_tcp;
    int32_t enable_incoming_tcp;
    int32_t enable_outgoing_utp;
    int32_t enable_incoming_utp;
